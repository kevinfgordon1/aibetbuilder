...

{
  ...
  assert.doesNotMatch(app, /Powered by Claude|Claude|Anthropic/);
  assert.doesNotMatch(indexHtml, /Powered by Claude|Claude|Anthropic/);
  assert.match(app, /className="lf-bn">AI Bet Builder</);
  assert.doesNotMatch(app, /lf-bs/);
  assert.doesNotMatch(app, />aibetbuilder\.io<\/div>/);
