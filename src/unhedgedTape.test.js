...
// ── Page is read-only and not inside Combo Locks ──
{
  ...
  assert.match(page, />Our fair</);
  assert.match(page, />Would-quote</);
  assert.doesNotMatch(page, /True \/ fair/);
  ...
  assert.match(page, />Our fair</);
  assert.match(page, />Kalshi opp</);
  assert.match(page, />Poly opp</);
  assert.match(page, /Best opp ask/);
  assert.match(page, /invert of best opponent ask/);
  assert.match(page, /opponent moneyline ask on Kalshi/);
  assert.match(page, /opponent ask on Polymarket/);
  assert.match(page, /Per-leg Kalshi\/Poly are opponent asks/);
