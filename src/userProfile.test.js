...

{
  ...
  assert.match(ui, /StatementBoard/);
  assert.match(ui, /useStatementView/);
  assert.match(ui, /downloadStatementCsv/);
  ...
  assert.match(board, /statementCsv/);
  ...
  assert.doesNotMatch(board, /<th>Kind<\/th>/);
