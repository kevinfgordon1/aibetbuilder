...

{
  ...
  assert.match(stamp, /freeFeedBooks/);
  assert.doesNotMatch(stamp, /bookIds/);
  ...
  assert.match(stamp, /FREE_FEED_POLL_MS/);
  assert.match(stamp, /FREE_FEED_LIVE_POLL_MS/);
  assert.doesNotMatch(stamp, /reconcileLiveGames/);
  assert.doesNotMatch(stamp, /BETSTAMP_PREGAME_POLL_MS|BETSTAMP_LIVE_RECONCILE_MS/);
  ...
  assert.match(stamp, /A blank — means this feed has no quote/);
  assert.match(stamp, /gamesFromFreeFeeds/);
  assert.doesNotMatch(stamp, /bookIdsKey/);
  ...
  assert.doesNotMatch(stamp, /applyFixtureMeta/);
  assert.match(stamp, /polymarketStreamUrl/);
  assert.match(stamp, /kalshiStreamUrl/);
  assert.match(stamp, /fetchUnderdogPhone/);
  ...
  assert.match(stamp, /data-free-feeds="polymarket,kalshi,underdog"/);
