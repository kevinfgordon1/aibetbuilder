...
function LiveTradingDeskView({ user }) {
  ...
  async function submit(e) {
    ...
    try {
      ...
      setNotice(
        rested + (protectSnap && protectSnap.on
  ...
  const canSubmit = !!(scoped && market.tradable && quote && quote.ok && ticket && protectReady && !crossBlocked && !busy);
