...
// Reads cached MLB odds (no Odds API pull). Scores 3-leg $100 0% boost parlays
// for every Promo Builder book. Alerts @evparlaysbot when EV% > 2.
// MLB only (baseball_mlb). Legs must commence within Promo Builder's "7 Days"
// window (isWithinDateRange "7d") and must not have already started.
...
// loadOddsCacheBySport stays generic — this endpoint passes SCAN_SPORT_KEYS
// (MLB only) so other leagues' JSON is never pulled.
