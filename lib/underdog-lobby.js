...
// (UNDERDOG_STALE_MS) without removing them from this payload. Staleness is
// per side, so Central Michigan can stay when Miami on the same game is
// frozen. Two-way moneylines whose implied probabilities sum outside
// 0.80–1.22 are omitted (Akron −527 / Central Michigan −715).
