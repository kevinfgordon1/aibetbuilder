...

{
  ...
  assert.deepEqual(parseRequestedSports('soccer_epl'), ['soccer_epl', 'soccer_usa_mls']);
  assert.deepEqual(parseRequestedSports('soccer_usa_mls,baseball_mlb'), [
    'baseball_mlb',
    'soccer_epl',
    'soccer_usa_mls',
  ]);
  assert.deepEqual(parseRequestedSports('soccer'), ['soccer_epl', 'soccer_usa_mls']);
  assert.ok(!FEATURED_SPORTS.includes('soccer'));
