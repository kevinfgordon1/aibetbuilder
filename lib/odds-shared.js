...
// underdog_predict is Betstamp-only. The gross sticker matches Kalshi's
// fee-inclusive print. Every Promo path uses odds.prediction when joined,
// else the leg builder's Kalshi-invert fallback (underdogPredictCashAmerican).
// Do not apply
// applyUnderdogPredictFee here — that UDX 0.072×p×(1−p) cost-add double-counts
// (Browns 4.31x sticker +331, not fee-true +308). Helper stays exported.
// ─────────────────────────────────────────────────────────────────────────
