...
// underdog_predict is Betstamp-only. Do not fee-adjust the sticker
// (UDX 0.072×p×(1−p) would turn Browns +331 into +308). New Odds Board
// omits book 196 in betstampNormalize; this function leaves an existing
// bookmaker price unchanged. Promo uses a joined odds.prediction american
// and omits the leg when that quote is missing. Do not apply
// applyUnderdogPredictFee here. Helper stays exported.
// ─────────────────────────────────────────────────────────────────────────
