...
// underdog_predict is Betstamp-only and already sticker-priced (the UDX
// fill is baked into the displayed decimal). Do not apply
// applyUnderdogPredictFee here — that 0.072×p×(1−p) cost-add double-counts
