...
// First-party live quotes for books Betstamp already columns on the New
// Odds Board. Betstamp stays. This module only normalizes venue ticks into
// a small quote shape the board can match onto an existing fixture.
//
...
function quotesFromKalshiMarket(market, league, teams) {
  ...
  return {
    ...
    // the game; yes_ask is the price. The LIVE board marks is_live.
    is_live: false,
    odds,
