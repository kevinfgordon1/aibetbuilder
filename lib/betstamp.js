...
// 196 = Underdog Predict on Betstamp (also Fanatics Markets / Crypto.com).
// Promo and the New Odds Board do not request 196. Phone prices come from
// /api/underdog-predict. 196 stays on the allowlist so an explicit
// book_ids=196 still parses; default fetches omit it. The board refuses
// to paint 196 even if a market arrives. /api/betstamp-markets is anon.
